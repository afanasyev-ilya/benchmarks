...
kernels: z_func_ker scatter_ker gather_ker fma_ker compute_latency_ker lehmer_ker L1_bandwidth_ker fib_ker dense_vec_ker interconnect_band_ker interconnect_latency_ker LLC_bandwidth_ker randgen_ker gather_private_ker gather_shared_ker
