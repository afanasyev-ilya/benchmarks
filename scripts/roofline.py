...
platform_specs = {
    "intel_xeon_6140": {"bandwidths": {"DRAM": 127, "LLC": 573, "L2": 1800, "L1": 18000},
                        "peak_performances": {"scalar": 82,
                                              "double": 1320,
                                              "float": 2649},
                        "cache_sizes": {"L1": 32*1024, "L2": 1024*1024, "L3": 24*1024*1024}},
    "kunpeng_920_64_core": {"bandwidths": {"DRAM": 187, "LLC": 1397, "L2": 4163, "L1": 7500},
                            "peak_performances": {"scalar": 332,
                                                  "double": 660,
                                                  "float": 1331},
                            "cache_sizes": {"L1": 64*1024, "L2": 512*1024, "L3": 65*1024*1024}},
    "a64fx": {"bandwidths": {"DRAM": 1024, "LLC": 6758, "L1": 13516},
                             "peak_performances": {"scalar": 105,
                                                   "double": 3379,
                                                   "float": 6758},
                             "cache_sizes": {"L1": 32*1024, "L2": 32*1024*1024}},
